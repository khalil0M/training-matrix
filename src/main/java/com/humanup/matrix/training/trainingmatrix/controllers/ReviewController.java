...
public class ReviewController {
    @Autowired
    private ReviewBS reviewBS;

    @Operation(summary = "Create new review", description = "Create new review", tags = { "review" })
    ...
    @Operation(summary = "Find review by score", description = "Find review by score.", tags = { "review" })
    ...
    @Operation(summary = "Find all reviews", description = "Find all reviews", tags = { "review" })
