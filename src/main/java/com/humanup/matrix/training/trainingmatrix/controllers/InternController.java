...
public class InternController {
    @Autowired
    private InternBS internBS;

    @Operation(summary = "Create new intern", description = "Create new intern", tags = { "intern" })
    @RequestMapping(value="/intern", method=RequestMethod.POST,consumes={ "application/json"})
    @ResponseBody
    public ResponseEntity createIntern(@RequestBody final InternVO intern) {
        final Optional<Object> internFound = Optional.ofNullable(internBS.getInternByEmail(intern.getEmailPerson()));
    ...
    @Operation(summary = "Find intern by id", description = "Find intern by id.", tags = { "intern" })
    ...
    @Operation(summary = "Find intern by email", description = "Find intern by email.", tags = { "intern" })
    @RequestMapping(value="/intern/email", method=RequestMethod.GET)
    @ResponseBody
    public ResponseEntity getInternByEmail(@RequestParam(value="email", defaultValue="robot@sqli.com") final String email){
    ...
    @Operation(summary = "Find all interns", description = "Find all interns", tags = { "intern" })
